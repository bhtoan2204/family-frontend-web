...
const FinanceIncomeMonthPicker = ({ month, setMonth, yearOfMonth, setYearOfMonth }: { month: number, setMonth: React.Dispatch<React.SetStateAction<number>>, yearOfMonth: number, setYearOfMonth: React.Dispatch<React.SetStateAction<number>> }) => {
...
export default FinanceIncomeMonthPicker