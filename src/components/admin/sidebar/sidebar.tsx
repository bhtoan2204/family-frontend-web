...
import SidebarLinkGroup from "@/components/admin/sidebar/sidebar-link-group";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  // Event listener to close sidebar on click outside
  useEffect(() => {
    const clickHandle = ({ target }: MouseEvent) => {
  ...
  // Event listener to close sidebar on escape key
  useEffect(() => {
    const keyHandle = ({ key }: KeyboardEvent) => {
